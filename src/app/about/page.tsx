        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-0 items-start w-full">
          ...
          <div className="lg:col-span-6 lg:col-start-7 flex flex-col justify-start">
              ...
              <div className="flex flex-col">
                {gear.map((item, index) => (
                  ...
                  >
                    ...
                    <div>
                      <span className="text-[0.95rem] tracking-wide text-[var(--color-text-primary)] font-light block mb-[6px] group-hover:text-white transition-colors duration-300">
                        {item.name}
                      </span>
            ...
            <div className="mt-[64px] md:mt-[96px] pt-[20px] border-t border-white/[0.08] max-w-[540px]">
              ...
              <h3 className="font-heading font-light text-2xl md:text-3xl tracking-tight mb-[16px] text-[var(--color-text-primary)]">
                {siteConfig.availability}.
              </h3>
              
              <p className="text-xs md:text-sm text-[var(--color-text-muted)] mb-[32px] tracking-[0.1em] uppercase font-medium">
