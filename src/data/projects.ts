...
export const projects: Project[] = [
  ...
  },
  {
    ...
    heroVideo: "/videos/2.mov",
    finalVideo: "/videos/3.mov",
    poster: "",
    gallery: [],
    featured: true,
    order: 2,
  },
  {
    ...
    heroVideo: "/videos/4.mov",
    finalVideo: "/videos/5.mov",
    poster: "",
    gallery: [],
    featured: true,
    order: 3,
  },
  {
    ...
    heroVideo: "/videos/6.mov",
    finalVideo: "/videos/7.mov",
    poster: "",
    gallery: [],
    featured: true,
    order: 4,
  },
  {
    ...
    heroVideo: "/videos/8.mov",
    finalVideo: "/videos/9.mov",
    poster: "",
    gallery: [],
    featured: true,
    order: 5,
