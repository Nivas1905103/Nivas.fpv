...
export default function Introduction() {
  return (
    <section className="relative section-padding bg-[var(--color-bg-primary)] overflow-hidden" id="introduction">
      ...
      <div className="container-site relative z-10 py-12 md:py-24">
        ...
        >
          <h2 className="heading-xl max-w-5xl mx-auto uppercase tracking-tighter text-center" style={{ fontSize: 'clamp(2.5rem, 10vw, 8rem)', lineHeight: 1.1 }}>
        ...
        >
          <div className="group bg-white/[0.02] backdrop-blur-xl border border-white/[0.05] rounded-[2rem] p-8 md:p-12 text-center transition-all duration-500 hover:-translate-y-2 hover:bg-white/[0.04] hover:border-white/[0.15] hover:shadow-2xl hover:shadow-[var(--color-accent)]/10 cursor-default">
