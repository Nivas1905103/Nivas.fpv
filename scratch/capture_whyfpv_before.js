...
async function captureWhyFPVBefore() {
  ...
  try {
    ...
    fs.writeFileSync(path.join(ARTIFACTS_DIR, "whyfpv_before_desktop.png"), Buffer.from(desktopShot.data, "base64"));
    ...
    fs.writeFileSync(path.join(ARTIFACTS_DIR, "whyfpv_before_mobile.png"), Buffer.from(mobileShot.data, "base64"));
...
captureWhyFPVBefore().catch(console.error);
